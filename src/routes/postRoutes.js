...
const { getPosts, setPost, updatePost, deletePost, getUserPosts, getPost, getUserBookmarks, setUserBookmark, likePost, removeLikePost } = require('../controlers/postControler');
...
router.post('/user/:userId', getUserPosts);
